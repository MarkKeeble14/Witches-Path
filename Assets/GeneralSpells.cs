...
namespace Spells
{
    ...
    public class Plague : ReusableSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellApplyAfflictionEffect(AfflictionType.Poison, () => PassValueThroughEffectivenessMultiplier(GetSpellStat(SpellStat.Aff1StackAmount)), Target.Other));
        }
    }
    ...
    public class Phase : ReusableSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellApplyAfflictionEffect(AfflictionType.Intangible, () => PassValueThroughEffectivenessMultiplier(GetSpellStat(SpellStat.Aff1StackAmount)), Target.Self));
        }
    }
    ...
    public class Reverberate : ReusableSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellApplyAfflictionEffect(AfflictionType.Echo, () => PassValueThroughEffectivenessMultiplier(GetSpellStat(SpellStat.Aff1StackAmount)), Target.Self));
        }
    }
    ...
    public class ImpartialAid : ReusableSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellAlterHPEffect(() => PassValueThroughEffectivenessMultiplier(GetSpellStat(SpellStat.HealAmount)), DamageType.Heal, Target.Both));
        }
    }
    ...
    public class WitchesWard : ReusableSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellWardEffect(() => PassValueThroughEffectivenessMultiplier(GetSpellStat(SpellStat.SelfWardAmount)), Target.Self));
        }
    }
    ...
    public class Greed : ReusableSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            SpellSingleAttackEffect singleAttack = new SpellSingleAttackEffect(() => PassValueThroughEffectivenessMultiplier(damageAmount), MainDamageType, Target.Both);
    ...
    public class Frusteration : ReusableSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellSingleAttackEffect(() => currentSelfDamageAmount, MainDamageType, Target.Self),
                new SpellSingleAttackEffect(() => PassValueThroughEffectivenessMultiplier(GetSpellStat(SpellStat.OtherDamageAmount)), MainDamageType, Target.Other));
        }
    }
    ...
    public class ChannelCurrent : ReusableSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellApplyAfflictionEffect(AfflictionType.Electrocuted, () => PassValueThroughEffectivenessMultiplier(GetSpellStat(SpellStat.Aff1StackAmount)), Target.Other),
    ...
    public class PoisonTips : PowerSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellApplyAfflictionEffect(AfflictionType.Embalmed, () => PassValueThroughEffectivenessMultiplier(GetSpellStat(SpellStat.Aff1StackAmount)), Target.Self));
        }
    }
    ...
    public class StaticField : PowerSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellApplyAfflictionEffect(AfflictionType.Charged, () => PassValueThroughEffectivenessMultiplier(GetSpellStat(SpellStat.Aff1StackAmount)), Target.Self));
        }
    }
    ...
    public class CrushJoints : PowerSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellApplyAfflictionEffect(AfflictionType.Brutish, () => PassValueThroughEffectivenessMultiplier(GetSpellStat(SpellStat.Aff1StackAmount)), Target.Self));
        }
    }
    ...
    public class MagicRain : PowerSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellApplyAfflictionEffect(AfflictionType.Stormy, () => PassValueThroughEffectivenessMultiplier(GetSpellStat(SpellStat.Aff1StackAmount)), Target.Self));
        }
    }
    ...
    public class TeslaCoil : PowerSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellApplyAfflictionEffect(AfflictionType.Conducting, () => PassValueThroughEffectivenessMultiplier(GetSpellStat(SpellStat.Aff1StackAmount)), Target.Self));
        }
    }
    ...
    public class Injure : PowerSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellApplyAfflictionEffect(AfflictionType.Hurt, () => PassValueThroughEffectivenessMultiplier(GetSpellStat(SpellStat.Aff1StackAmount)), Target.Self));
        }
    }
    ...
    public class Worry : PowerSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellApplyAfflictionEffect(AfflictionType.Worried, () => PassValueThroughEffectivenessMultiplier(GetSpellStat(SpellStat.Aff1StackAmount)), Target.Self));
        }
    }
    ...
    public class Levitate : ReusableSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellApplyAfflictionEffect(AfflictionType.Levitating, () => PassValueThroughEffectivenessMultiplier(GetSpellStat(SpellStat.Aff1StackAmount)), Target.Self));
        }
    }
    ...
    public class StudyPower : ReusableSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellApplyAfflictionEffect(AfflictionType.Power, () => PassValueThroughEffectivenessMultiplier(GetSpellStat(SpellStat.Aff1StackAmount)), Target.Self));
        }
    }
    ...
    public class StudyProtection : ReusableSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellApplyAfflictionEffect(AfflictionType.Protection, () => PassValueThroughEffectivenessMultiplier(GetSpellStat(SpellStat.Aff1StackAmount)), Target.Self));
        }
    }
    ...
    public class FlamingLashes : ReusableSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellMultiAttackEffect(() => PassValueThroughEffectivenessMultiplier(GetSpellStat(SpellStat.OtherDamageAmount)), () => GetSpellStat(SpellStat.HitAmount), MainDamageType, Target.Other),
    ...
    public class Blessed : ReusableSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellApplyAfflictionEffect(AfflictionType.Regeneration, () => PassValueThroughEffectivenessMultiplier(GetSpellStat(SpellStat.Aff1StackAmount)), Target.Self));
        }
    }
    ...
    public class Recouperate : ReusableSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellAlterHPEffect(() => PassValueThroughEffectivenessMultiplier(GetSpellStat(SpellStat.HealAmount)), MainDamageType, Target.Self));
        }
    }
    ...
    public class CoatEdges : ReusableSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellApplyAfflictionEffect(AfflictionType.PoisonCoated, () => PassValueThroughEffectivenessMultiplier(GetSpellStat(SpellStat.Aff1StackAmount)), Target.Self));
        }
    }
    ...
    public class Ghost : ReusableSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellApplyAfflictionEffect(AfflictionType.Ghostly, () => PassValueThroughEffectivenessMultiplier(GetSpellStat(SpellStat.Aff1StackAmount)), Target.Self));
        }
    }
    ...
    public class Sap : ReusableSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellApplyAfflictionEffect(AfflictionType.Power, () => PassValueThroughEffectivenessMultiplier(-GetSpellStat(SpellStat.Aff1StackAmount)), Target.Other));
        }
    }
    ...
    public class GrowSpikes : ReusableSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellApplyAfflictionEffect(AfflictionType.Thorns, () => PassValueThroughEffectivenessMultiplier(GetSpellStat(SpellStat.Aff1StackAmount)), Target.Self));
        }
    }
    ...
    public class LoseResolve : ReusableSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellApplyAfflictionEffect(AfflictionType.Jumpy, () => PassValueThroughEffectivenessMultiplier(GetSpellStat(SpellStat.Aff1StackAmount)), Target.Self));
        }
    }
    ...
    public class Unleash : ReusableSpell
    {
        ...
        protected override void SetSpellEffects()
        {
            AddSpellEffectCallback(SpellCallbackType.OnCast, new SpellCleanseAfflictionsEffect(Target.Self, Sign.Negative));
        }
    }
}