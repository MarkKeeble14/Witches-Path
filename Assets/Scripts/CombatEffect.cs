...
public abstract class CombatEffect : ToolTippable
{
    public abstract CombatEffectType Type { get; }
    protected abstract string name { get; }
    protected abstract string toolTipText { get; }
    private string additionalText = "";
    public abstract string NumText { get; }
    public Sprite Sprite => UIManager._Instance.GetCombatEffectIcon(Type);
    ...
    public CombatEffect(Target target)
    {
        this.target = target;
        AddKeywords();
    }
...
public abstract class AttackEffect : CombatEffect
{
    ...
    public AttackEffect(Func<int> damageAmount, DamageType damageType, AttackAnimationStyle animationStyle, Target target) : base(target)
    {
...
public class SingleAttackEffect : AttackEffect
{
    public override CombatEffectType Type => CombatEffectType.SingleAttack;
    ...
    public SingleAttackEffect(Func<int> damageAmount, DamageType damageType, Target target) : base(damageAmount, damageType, AttackAnimationStyle.Once, target)
    {
    }
}

public class LeechingAttackEffect : AttackEffect
{
    public override CombatEffectType Type => CombatEffectType.LeechingAttack;
    ...
    public LeechingAttackEffect(Func<int> damageAmount, DamageType damageType, Target target) : base(damageAmount, damageType, AttackAnimationStyle.Once, target)
    {
    }
}


public class MultiAttackEffect : AttackEffect
{
    public override CombatEffectType Type => CombatEffectType.MultiAttack;
    ...
    public MultiAttackEffect(Func<int> damageAmount, Func<int> numAttacks, DamageType damageType, Target target, AttackAnimationStyle animationStyle = AttackAnimationStyle.PerAttack,
    ...
    public MultiAttackEffect(int damageAmount, Func<int> numAttacks, DamageType damageType, Target target, AttackAnimationStyle animationStyle = AttackAnimationStyle.PerAttack,
        float timeBetweenAttacks = 0.1f)
        : base(() => damageAmount, damageType, animationStyle, target)
    {
        this.numAttacks = numAttacks;
...
public class WardEffect : CombatEffect
{
    public override CombatEffectType Type => CombatEffectType.Ward;
    ...
    public WardEffect(Func<int> wardAmount, Target target) : base(target)
    {
...
// Afflictions
public class ApplyAfflictionEffect : CombatEffect
{
    public AfflictionType AfflictionType { get; protected set; }
    public override CombatEffectType Type => CombatEffectType.ApplyAffliction;
    ...
    public ApplyAfflictionEffect(AfflictionType affType, Func<int> numStacks, Target target) : base(target)
    {
...
public class CleanseAfflictionsEffect : CombatEffect
{
    public override CombatEffectType Type => CombatEffectType.CleanseAfflictions;
    ...
    public CleanseAfflictionsEffect(Target target, params Sign[] affOfSignsToCleanse) : base(target)
    {
...
// Alter HP
public class AlterCurrentHPEffect : CombatEffect
{
    ...
    public override CombatEffectType Type => CombatEffectType.AlterHP;

    public AlterCurrentHPEffect(Func<int> hpAmount, DamageType damageType, Target target) : base(target)
    {
        DamageType = damageType;
...
// Alter Max HP
public class AlterPlayerMaxHPEffect : CombatEffect
{
    private Func<int> hpAmount { get; set; }
    public int HPAmount => hpAmount();
    ...
    public override string NumText => HPAmount.ToString();
    public override CombatEffectType Type => CombatEffectType.AlterMaxHP;

    public AlterPlayerMaxHPEffect(Func<int> hpAmount) : base(Target.Self)
    {
        this.hpAmount = hpAmount;
    }
}
...
public class AlterQueuedSpellEffect : CombatEffect
{
    public override CombatEffectType Type => CombatEffectType.AlterQueuedSpell;
    ...
    public AlterQueuedSpellEffect(Func<int> alterBy, SpellAlterStatDuration alteredStatDuration, Target target, params LabeledSpellStat[] applicableStats) : base(target)
    {
...
public class QueueSpellEffect : CombatEffect
{
    public override CombatEffectType Type => CombatEffectType.QueueSpell;
    ...
    public QueueSpellEffect(Spell toQueue, QueuePosition queuePosition, Target target) : base(target)
    {
        ToQueue = toQueue;
...
public class PlayerDrawSpellsEffect : CombatEffect
{
    public override CombatEffectType Type => CombatEffectType.PlayerDrawSpells;
    ...
    public PlayerDrawSpellsEffect(Func<int> numSpells) : base(Target.Self)
    {
        this.numSpells = numSpells;
    }
}

public class PlayerDiscardSpellsEffect : CombatEffect
{
    public override CombatEffectType Type => CombatEffectType.PlayerDiscardSpells;
    ...
    public PlayerDiscardSpellsEffect(Func<int> numSpells, bool letChoose, Action<Spell> doToSelected = null, Func<string> additionalInfo = null) : base(Target.Self)
    {
        this.numSpells = numSpells;
        LetChoose = letChoose;
...
public class PlayerExhaustSpellsEffect : CombatEffect
{
    public override CombatEffectType Type => CombatEffectType.PlayerExhaustSpells;
    ...
    public Action<Spell> DoToSelected { get; private set; }
    private Func<string> additionalInfo;
    public PlayerExhaustSpellsEffect(Func<int> numSpells, bool letChoose, Action<Spell> doToSelected = null, Func<string> additionalInfo = null) : base(Target.Self)
    {
        this.numSpells = numSpells;
        LetChoose = letChoose;
        DoToSelected = doToSelected;
...
public class TickPrepTimeEffect : CombatEffect
{
    public override CombatEffectType Type => CombatEffectType.TickPrepTime;
    ...
    public TickPrepTimeEffect(Func<int> tickAmount, Target target) : base(target)
    {
        this.tickAmount = tickAmount;
    }
}

public class AlterPlayerCurrentManaEffect : CombatEffect
{
    public override CombatEffectType Type => CombatEffectType.AlterCurrentMana;
    ...
    public AlterPlayerCurrentManaEffect(Func<int> alterBy) : base(Target.Self)
    {
        this.alterBy = alterBy;
    }
}

public class AddSpellToDeckEffect : CombatEffect
{
    public override CombatEffectType Type => CombatEffectType.AddSpellToDeck;
