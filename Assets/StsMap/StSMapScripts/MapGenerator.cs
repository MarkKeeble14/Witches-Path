...
namespace Map
{
    public static class MapGenerator
    {
        ...
        {
            NodeType.MinorEnemy, NodeType.Apothecary, NodeType.Clothier, NodeType.Library, NodeType.Event, NodeType.Campfire
        };
        ...
        private static void PlaceLayer(int layerIndex)
        {
            ...
            for (int i = 0; i < config.GridWidth; i++)
            {
                ...
                Debug.Log(nodeType + ", " + config.nodeBlueprints.Where(b => b.nodeType == nodeType).Count());
